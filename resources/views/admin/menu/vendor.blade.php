                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ url('/admin/vendor/hapus') }}" method="post" style="display:inline;">
                                                ...
                                                <button style="width:120px;margin-top:10px;" onclick="return confirm('Yakin ingin menghapus vendor?')" type="submit" class="btn btn-danger btn-sm">Hapus</button>
                                            </form>
                                        </td>
                                    </tr>
                                    @endforeach
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                            ...
                            <input type="file" class="form-control" accept="video/mp4,video/avi,video/wmv,video/mov" id="inputVideo" name="video" required>
                            </div>
                            </div>
                            <div class="form-group">
                            <label for="inputGambar" class="form-label">Gambar</label>
                            <input type="file" class="form-control" accept="image/*" id="inputGambar" name="gambar" required>
                            </div>
                        ...
                        <div class="col-md-6">
                         <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" accept="video/mp4,video/avi,video/wmv,video/mov" id="editVideo" name="video" >

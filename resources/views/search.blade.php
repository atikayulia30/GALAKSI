                        ...
                        <div class="col-lg-4">
                            <div class="card p-3"
                                ...
                                <div style="margin-top:25px;height: 150px; overflow: hidden;">
                                    <img src="{{ asset('foto_vendor/ikon.png') }}"
                                ...
                                <p>{{ substr(strip_tags($data->deskripsi), 0, 100) }}{{ strlen(strip_tags($data->deskripsi)) > 100 ? "..." : "" }}
                                </p>

                                <a href="{{url('/blog/'.$data->id)}}" class="primary-btn"
                                    style="text-align:center;">Lihat</a>
                            </div>
                        </div>
                        @endforeach
                    </div>
